...
(() => {
  ...
  // src/logo.svg
  var logo_default = "./logo-IQMZ6C52.svg";
  ...
  var _App = class _App extends Component {
    ...
    render() {
      return /* @__PURE__ */ VDOM.createNode("div", { id: "app" }, /* @__PURE__ */ VDOM.createNode("div", { id: "app-title" }, /* @__PURE__ */ VDOM.createNode("img", { src: logo_default })), /* @__PURE__ */ VDOM.createNode("div", { id: "app-click-count" }, "You clicked ", this.state.clicks, " times!"), /* @__PURE__ */ VDOM.createNode("div", { id: "app-button" }, /* @__PURE__ */ VDOM.createNode(Button, { onClick: () => {
        this.state.clicks++;
      } }, "Click me!")));
    }
  };
